    ...
    >
      ...
      <div className="mt-8 mb-20">
        ...
        <p className="mb-6 mx-auto max-w-lg md:mb-10 lg:leading-loose">
          ...
          As a tech enthusiast, I thrive on coding and welcome new challenges
          with open arms. If you're looking for collaboration or aiming to
          create something remarkable, feel free to reach out to me!
        </p>
        <LinkButton href="mailto:mohdtalib6678@gmail.com">
          Get in touch!
        </LinkButton>
      </div>
    </section>
